    ...
    for (let i = 0; i < 24; i++) {
      ...
      for (const path of paths) {
        ...
        if (bp.ore.ore <= newCount.ore) {
          newPaths.push([["ore", ...path[0]], inc(path[0], {
            ...newCount,
        ...
        if (bp.clay.ore <= newCount.ore) {
          newPaths.push([["clay", ...path[0]], inc(path[0], {
            ...newCount,
        ...
        if (bp.obsidian.ore <= newCount.ore && bp.obsidian.clay <= newCount.clay) {
          ...
          newPaths.push([["obsidian", ...path[0]], inc(path[0], {
            ...newCount,
        ...
        if (bp.geode.ore <= newCount.ore && bp.geode.obsidian <= newCount.obsidian) {
          ...
          newPaths.push([["geode", ...path[0]], inc(path[0], {
            ...newCount,
      ...
      newPaths.sort((a, b) => b[0].count(i => i === "obsidian") - a[0].count(i => i === "obsidian"));
