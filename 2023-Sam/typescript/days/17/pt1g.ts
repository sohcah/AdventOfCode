...
for (let rotation = 0; rotation < 4; rotation++) {
  for (let noSteps = 0; noSteps < 11; noSteps++) {
    ...
    validMoves[n] = (rotation !== 0 || noSteps < 3) && rotation !== 2 ? 1 : 0;
    validMoves[n + 1] = (rotation !== 2 || noSteps < 3) && rotation !== 0 ? 1 : 0;
    validMoves[n + 2] = (rotation !== 1 || noSteps < 3) && rotation !== 3 ? 1 : 0;
    validMoves[n + 3] = (rotation !== 3 || noSteps < 3) && rotation !== 1 ? 1 : 0;
  }
}
...
while (!positions.isEmpty()) {
  ...
  if (position.x < width - 1 && validMoves[m] === 1) {
    positions.push(
      new Position(
        position.x + 1,
        position.y,
  ...
  if (position.x > 0 && validMoves[m + 1] === 1) {
    positions.push(
      new Position(
        position.x - 1,
        position.y,
  ...
  if (position.y < height - 1 && validMoves[m + 2] === 1) {
    positions.push(
      new Position(
        position.x,
        position.y + 1,
  ...
  if (position.y > 0 && validMoves[m + 3] === 1) {
    positions.push(
      new Position(
        position.x,
        position.y - 1,
