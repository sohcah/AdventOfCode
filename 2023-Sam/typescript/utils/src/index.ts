...
import type { DayInput, DayResult } from "../../../scripts/runHelpers.js";
...
export function assertTypeNotAny<T>(_value: NotAny<T>) {}
...
export function _load<TParser extends UnnamedParser<any> | undefined = undefined>(
  parser: TParser = undefined as TParser
): TParser extends undefined ? string : ResultOf<NonNullable<TParser>> {
...
export function loadLines<TParser extends UnnamedParser<any> | undefined = undefined>(
  parser: TParser = undefined as TParser
): TParser extends undefined ? string[] : ResultOf<NonNullable<TParser>>[] {
...
export function stabilise(start: number, increment: number, stableCount: number): number {
